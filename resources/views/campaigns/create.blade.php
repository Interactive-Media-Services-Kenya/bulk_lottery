        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Add Campaign</h3>
                    <p class="text-subtitle text-muted">Add Campaign Details</p>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Enter Campaign Information</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form" action="{{ route('campaigns.store') }}" method="POST">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            ...
                                            <fieldset class="form-group">
                                                <select class="form-select dynamicClient" id="basicSelect" name="client_id"
                                                    data-dependent="brand_id" required>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="datetime-local" id="city-column" class="form-control"
                                                    placeholder="Start Date" required name="start_date">
                                            </div>
                                            @error('start_date')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
