            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edit {{$client->name}} Company Information</h4>
                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                                placeholder="Company Name" name="name" value="{{$client->name}}">
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="last-name-column" class="form-control"
                                                placeholder="info@company.com" name="email" value="{{$client->email}}">
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="country-floating" class="form-control"
                                                name="address" placeholder="1234 Nairobi" value="{{$client->address}}">
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="city" placeholder="Nairobi" value="{{$client->city}}">
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="email-id-column" class="form-control"
                                                name="zip" placeholder="123456" value="{{$client->zip}}">
                                        </div>
