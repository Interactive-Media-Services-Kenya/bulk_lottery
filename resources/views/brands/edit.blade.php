    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Edit Brand</h3>
                <p class="text-subtitle text-muted">Edit Brand Details</p>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edit {{$brand->name}} Information</h4>
                    </div>
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                                placeholder="Campaign Name" name="name" value="{{$brand->name}}">
                                        </div>
