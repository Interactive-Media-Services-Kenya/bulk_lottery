                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0">KES {{$transactionsCustomer['totalTransactions']}}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0">KES {{$transactionsCustomer['transactionsToday']}}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0">KES {{$transactionsCustomer['transactionsWeek']}}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0">KES {{$transactionsCustomer['transactionsMonth']}}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Messages Sent Statistics</h4>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover table-lg">
                                        ...
                                        <tbody>
                                            @forelse ($latestStats['latestTransactions'] as $transaction )
                                                <tr>
                                                    <td class="col-3">
                                                        <div class="d-flex align-items-center">
                                                            <p class="font-bold ms-3 mb-0">{{$transaction->reference}}</p>
                                                        </div>
                                                    </td>
                                                    <td class="col-auto">
                                            ...
                                            @empty
                                            <tr>
                                                <td colspan="3" class="col-auto text-center">
            ...
            <div class="col-12 col-lg-3">
                ...
                <div class="card">
                    ...
                    <div class="card-content pb-4">
                        @forelse ($latestStats['latestMessages'] as $message)
                            <div class="recent-message d-flex px-4 py-3">
                                {{-- <div class="avatar avatar-lg">
                                    <img src="assets/images/faces/4.jpg">
                                </div> --}}
                                <div class="name ms-4">
                                    <h5 class="mb-1">{{ \Str::of($message->message)->words(5,' ...')}}</h5>
                                </div>
                            </div>
                        @empty
                        <div class="recent-message d-flex px-4 py-3">
                        ...
                        @endforelse
                        <div class="px-4">
                            <a href="{{route('messages.create')}}" class='btn btn-block btn-xl btn-outline-primary font-bold mt-3'>Import Messages</a>
                        </div>
                    </div>
                </div>
                {{-- <div class="card">
